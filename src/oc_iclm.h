...
namespace opencorr
{
	...
	class ICLM2D1 : public DIC, public SplittablePrepare2D, public GradientPopulatingSolver2D
	{
	private:
	...
	class ICLM2D2 : public DIC, public SplittablePrepare2D, public GradientPopulatingSolver2D
	{
	private:
